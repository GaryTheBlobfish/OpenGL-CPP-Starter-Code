...
int main(void)
{
	...
	window = glfwCreateWindow(1600, 900, "C++ OpenGL Game", NULL, NULL);
	...
	FileLogging::writeToTextFile("Game: Vertex Shader:\n" + src.VertexSource + "\n\n");
	FileLogging::writeToTextFile("Game: Fragment Shader:\n" + src.FragmentSource + "\n\n");
